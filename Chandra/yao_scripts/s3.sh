...
#SLOW#
    ...
    #specextract infile="../evt2_c7_srcless.fits[sky=region(ans6.reg)]" outroot=src bkgfile="../acis_bkg_reproj.fits[sky=region(ans6.reg)]" pbkfile="../../../secondary/acisf_pbk0.fits" grouptype=NUM_CTS binspec=20 verbose=5
