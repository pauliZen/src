      SUBROUTINE GRBIN(M1,M2,X,V,SEMI,ECC,EBIN)
*
*
...
*
     ...
     &         - 1./16*ETA*(9 - 84*ETA + 165*ETA2)*MR*V2*RD**4
          E3 = E3/CLIGHT**6
*         FAC3 = (2.5 - (5199.0/280.0 - 41.0/32.0*PI2)*ETA -
*    &            7.0*ETA2 + ETA*ETA2)*MR**3 +
*    &            1.0/16.0*(5.0 - 59.0*ETA + 238.0*ETA2 -
*    &            323.0*ETA*ETA2)*V2**3 +
*    &            1.0/12*(135.0 - 322.0*ETA + 315.0*ETA2 -
*    &            108.0*ETA*ETA2)*MR**2*V2 +
*    &            1.0/8.0*(33.0 - 142.0*ETA + 106.0*ETA2 +
*    &            195.0*ETA*ETA2)*MR*V2**2
          FAC3 = 0.0
      ELSE
          E3 = 0.0
          FAC3 = 0.0
