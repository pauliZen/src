...
*
*       Introduce physical coordinates & momenta in local c.m. system.
    4 DO 6 I = 1,3
          DO 5 K = 1,3
              I1 = 3*I + K - 3
              Q1(I1) = X(K,I)
...
*       Absolute momentum of reference body (last eqn (55)).
   26 CONTINUE
*
*       Specify coordinates & velocities in perturbed c.m. frame.
      DO 30 I = 1,3
          DO 28 K = 1,3
              I1 = 3*I + K - 3
              X(K,I) = Q2(I1)
...
*       Evaluate total energy & relative energy error.
     ...
     &                                         (Q2(6) - Q2(3))**2)
      HT = ZKE - S1 - S2 - S3
*       Form relative energy error with respect to initial value.
