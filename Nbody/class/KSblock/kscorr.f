...
*
     ...
     &        U2(4),U3(4),U4(4),U5(4),VKSD(10),VKSD2(10)
...
*
      ...
      DO 50 K = 1,4
          VKSD(K) = FAC1*UIDOT(K)
          VKSD2(K) = FAC2*UIDOT(K) + 0.5*FAC3*FREG(K)
   50 CONTINUE
*
      DO 60 K = 5,8
          VKSD(K) = 0.5*FAC1*FREG(K-4)
          VKSD2(K) = 0.5*FAC2*FREG(K-4) + FAC3*FRD(K-4)
   60 CONTINUE
      VKSD(9) = 2.0*FAC1*HD
      VKSD2(9) = 2.0*FAC2*HD + FAC3*HD2
*
