...
***** --lwang-add call this_planet.f-----------------------------------**
      INCLUDE 'common6.h'
*     --11/07/12 0:53-lwang-close-encounter----------------------------*
***** Note:common criterion for close encounter search-----------------**
      COMMON/WL/ WL_RADIUS
*     --11/07/12 0:54-lwang-end-close-encounter------------------------*
...
*
*     lwang-thijs-change------------------------------------------------*
***** Note: call thijs_planets-----------------------------------------**
      WL_RADIUS=(1000.0/RAU)**2
      call getnstar(N)
      CALL THIJS_PLANETS
*     --11/05/12 8:02-lwang-end-close encounter------------------------*
