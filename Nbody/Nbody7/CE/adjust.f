...
*     --11/05/12 8:02-lwang-close encounter----------------------------*
***** Note:call writing function to store data in root-----------------**
         call getunit(RBAR,RAU,TSTAR,ZMBAR,VSTAR)
         call bdata_close()
         call endstore
*     --11/05/12 8:03-lwang-end-close encounter------------------------*
