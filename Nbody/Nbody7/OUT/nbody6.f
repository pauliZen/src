...
*
      INCLUDE 'common6.h'
*     --02/05/13 13:57-lwang-output root--------------------------------*
***** Note:output root initial-----------------------------------------**
      INTEGER N_root, FNUM_root
*     --02/05/13 13:57-lwang-end-output root----------------------------*
      EXTERNAL MERGE
*
*
...
*     --02/05/13 13:20-lwang-output restart ----------------------------*
***** Note:output root initial ----------------------------------------**
         READ (5,*) N_root, FNUM_root
         call bdata_restart(N_root, FNUM_root)
*     --02/05/13 13:20-lwang-end-output restart-------------------------*
          CALL MYDUMP(0,1)
          IF (NDUMP.GE.3) STOP
