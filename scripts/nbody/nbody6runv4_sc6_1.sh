...
SRunNum=6                                  #run numbers together
...
Nstar='2000'               #Number of starn 1 i
#Rbar='0.466 1.112 2.117 4.997 9.057'        #Initial Radius 2 j
Rbar='2'        #Initial Radius 2 j
RatioNb='0 0.2 0.5'                            #Nbinary/Nstars r
RatioNpNs='0.5 1 2'                      #N_planets/stars s
#vdist='4'                                #vdist  0: normal, 4: eject l
M1='1'                                   #Choose 1Ms or 0.6Ms
P1='1'                                   #Choose delay or prompt
rand='303 11611 56339 8387 323426 23435 835654 34352 362348 754230'                     #change random seed 5 m
...
function winput()
{
    ...
    echo $1 1 20 $7 45 1'                               # N, NFIX, NCRIT, NRAND, NNBMAX, NRUN'>>input
    ...
    echo 1 `calc \* $1 $4` 0.001 1.0 0.5 4 10 0.1 $5 $6'                   # USEPLANET, NPLANET, MPLANET, RPLANET, QPLANET, VDIST, VMU, VSIG, M1, VPAR2'>>input
}
...
echo '** Nstars_Rbar_RatioNb_RatioNpNs_M1_P1_NRAND'>>Info.txt   # C
	...
	do
		...
		do
			...
			do
			    for m in $rand
			    do
				curdir=$i'_'$j'_'$k'_'$n'_'$q'_'$p'_'$m
