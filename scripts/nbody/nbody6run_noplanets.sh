...
SRunNum=7                                  #run numbers together
Appname=nbody6_origin                         #program name
...
Nstar='150 500 700 1000'               #Number of starn 1 i
Rbar='0.466 1.112 4.997'        #Initial Radius 2 j
RatioNb='0.2 0.3'                            #Nbinary/Nstars r
#Qp='1 2'                                   #Choose for vdist pars 4 k
...
function winput()
{
    ...
    echo $1 1 15 $4 45 1'                               # N, NFIX, NCRIT, NRAND, NNBMAX, NRUN'>>input
    echo 0.02 0.02 0.3 2.0 20 10000. 2.0D-04 $2 -1234'     # ETAI, ETAR, RS0, DTADJ, DELTAT, TCRIT, QE, RBAR, ZMBAR'>>input
    ...
    echo 5E-06 0.005 0.2 1.0 1.0E-06 0.001'                 # DTMIN, RMIN, ETAU, ECLOSE, GMIN, GMAX'>>input
...
#    echo 0 100 0.001 1.0 0.5 4 10 0.1 1 1'                   # USEPLANET, NPLANET, MPLANET, RPLANET, QPLANET, VDIST, VMU, VSIG, M1, VPAR2'>>input
}
...
echo '** N_Rbar_RatioNb_NRAND'>>Info.txt             # C
